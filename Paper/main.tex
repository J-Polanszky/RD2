...
% You could add a short paragraph explicitly discussing validity (e.g., sample size, playtest design), reliability (consistency of results), and generalizability (applicability to other games or genres). 
% You touch on these in your methodology, but a brief mention here would strengthen the critique.
