...
% Have notes about papers locally, but have not formulated them into a proper literature review yet. Should focus on discussing their results, as most fall between the above 2 mentioned papers, and another one
% which takes a different approach, which might be out of scope. Discuss the advantages and disadvantages of each approach, being balancing the difficulty using snapshots, and building DDA into the agent's
% reward structure (fighting game paper)
